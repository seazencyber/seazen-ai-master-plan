...
> **Task:** Thiết kế và vận hành minigame truyền thông nội bộ về SOP 10 bước vận hành. Đối tượng chính: khối đội (~18 nhân viên bảo vệ).
> 
> **Phạm vi MARKETING — em làm những việc sau:**
> - Phối hợp với phòng vận hành để lấy nội dung chuẩn 10 bước SOP
> - Chuyển nội dung SOP thành format dễ tiêu hóa (infographic, video ngắn, quiz)
> - Thiết kế cơ chế minigame (quiz có thưởng) để CBNV tự đọc, tự ghi nhớ
> - Truyền thông trước/trong/sau minigame (post fanpage nội bộ, Zalo nhóm)
> - Đo lường mức độ tiếp cận và ghi nhớ qua kết quả quiz
> 
> **NGOÀI phạm vi marketing — không phải task của em:**
> - Tổ chức buổi đào tạo trực tiếp (training session) — phòng vận hành/HR
> - Kiểm tra kỹ năng thực hành SOP — quản lý đội
> - Đánh giá xem CBNV có thực hiện đúng SOP trong công việc thực tế hay không — quản lý đội
> 
> **Deadline:**
> - Plan trình anh: trước ngày ___
> - Phối hợp với phòng vận hành xong nội dung: ngày ___
> - Minigame chạy: tuần ___ đến tuần ___
> - Báo cáo kết quả: ngày ___
> 
> **Output cuối em sẽ giao:**
> - Plan đủ 6 mục (theo M1)
> - Bộ tài liệu 10 bước SOP đã chuyển ngữ thân thiện (1 infographic hoặc video ≤2 phút)
> - Quiz 10 câu hỏi về 10 bước SOP (Google Form hoặc Zalo Quiz)
> - Banner + 3-5 post truyền thông (trước launch, đang chạy, kết quả)
> - Báo cáo kết quả với 3 chỉ số dưới
> 
> **Tiêu chí "xong" — KPI trong phạm vi marketing:**
> - Tiếp cận: ≥90% khối đội (≥16/18 người) đọc/xem tài liệu SOP qua kênh truyền thông
> - Tham gia: ≥80% khối đội (≥15/18 người) làm quiz
> - Ghi nhớ: ≥70% người làm quiz trả lời đúng ≥7/10 câu về SOP
> *(3 KPI trên đo bằng: số click vào tài liệu, số submission Google Form, % đáp án đúng tự động)*
> 
> **Quan trọng — em xác nhận lại ranh giới:**
...
> 3. Giải thưởng minigame: em đề xuất trước, anh duyệt ngân sách trước khi launch truyền thông
> Còn lại OK theo brief em viết. Bắt đầu làm.

**Tại sao brief này tốt:**
1. Vạch ranh giới marketing rõ ngay từ đầu.
2. KPI marketing là KPI đo được bằng kênh marketing, không phải KPI đo được bằng kiểm tra ca trực.
...
export default function App() {
  ...
  const generateMarkdown = (member) => {
    ...
    md += `- ✅ "Cụ thể là đoạn mở đầu (1) — em viết dài 5 câu mới đến CTA, mà CBNV khối đội đọc trên điện thoại lúc nghỉ trưa thì thường lướt qua sau 2 dòng (2). Em rút mở đầu xuống còn 1 câu hook + 1 câu CTA ngay, phần giải thích chi tiết đẩy xuống dưới (3)."\n\n`;
    md += `- ❌ "Plan không thực tế."\n`;
    md += `- ✅ "Phần research của em (1) đang nêu 3 công ty nhưng không có link, anh không kiểm chứng được — và nội dung em mô tả nghe giống AI bịa, không khớp với cách công ty bảo vệ thật làm truyền thông (2). Em quay lại tìm 3 công ty bảo vệ thật, gửi link cụ thể, mô tả họ làm gì trong 5 câu mỗi case (3)."\n\n`;
    md += `- ❌ "Banner xấu."\n`;
    md += `- ✅ "Phần text trên banner (1) — màu vàng trên nền trắng đọc không rõ, đặc biệt trên điện thoại (2). Em đổi text sang màu xanh đậm của brand, hoặc giữ vàng nhưng thêm nền tối đằng sau (3)."\n\n`;
    md += `**Nguyên tắc thêm:**\n`;
    ...
    md += `**4. Không giao thêm task mới khi đang gánh task chính**\n\n`;
